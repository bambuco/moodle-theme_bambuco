...
$string['courseheaderview_anycourse'] = 'Any course page';
...
$string['courseheaderview_grade'] = 'Gradebook';
...
$string['coursesheaderposition_over'] = 'Over page';
...
$string['subthemescachecleared'] = 'Subthemes cache cleared';
$string['subthemesclearcache'] = 'Clear subthemes cache';
$string['subthemesclearcacheconfirm'] = 'Are you sure you want to clear subthemes cache?';
