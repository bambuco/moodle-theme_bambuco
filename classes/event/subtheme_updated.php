 ...
 *
 */
class subtheme_updated extends \core\event\base {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('eventsubtheme_updated', 'theme_bambuco');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the subtheme with id '$this->objectid'.";
    }
